...
const Data = () => {
  return (
    <div className="home-data">
        <h1 className="home-title">Pranit kamble
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        Passionate Full Stack Web Developer Expertise in Frontend & Backend Technologies and  Continuous Learner
        </p>
        <a target='-blank' href="https://www.linkedin.com/in/pranit-kamble-1463281a8/" className='button button--flex'>
            say Hello
            <svg
